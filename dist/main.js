...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/check-mark.svg */ "./src/assets/check-mark.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/star.svg */ "./src/assets/star.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/star_filled.svg */ "./src/assets/star_filled.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/edit.svg */ "./src/assets/edit.svg"), __webpack_require__.b);
...
/* harmony import */ var _Task_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Task.js */ "./src/classes/Task.js");
...
class DomController {
    ...
    addNewTask() {
        ...
        const task = new _Task_js__WEBPACK_IMPORTED_MODULE_0__["default"](titleInput.value, description.value, new Date(dueDate.value), this.currentProject.getName());
    ...
    newTaskContainer(task) {
        ...
        date.textContent = this.isExpose(task.getDueDate()) ? "Expired" : (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(task.getDueDate(), 'dd/MM/yyyy');
    ...
    addingNewProject() {
        ...
        projectContainer.addEventListener("submit", (event) => {
            event.preventDefault();
            const newProject = new _Project_js__WEBPACK_IMPORTED_MODULE_1__["default"](title.value);
    ...
    isExpose(date) {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isAfter)(new Date(), date);
    }
    ...
    showTaskDetails(task) {
        ...
        dueDate.textContent = `Due Date: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(task.getDueDate(), 'dd/MM/yyyy')}`;
    ...
    loadFromLocalStorage() {
        ...
        if (savedProjects) {
            ...
            projectsData.forEach(projectData => {
                const loadedProject = new _Project_js__WEBPACK_IMPORTED_MODULE_1__["default"](projectData.name);
                projectData.tasks.forEach(taskData => {
                    const task = new _Task_js__WEBPACK_IMPORTED_MODULE_0__["default"](taskData.title, taskData.description, new Date(taskData.dueDate), loadedProject.getName());
                    task.id = taskData.id;
...
class Project {
    ...
    createNewTask(title, description, dueDate) {
        const newTask = new _Task_js__WEBPACK_IMPORTED_MODULE_0__["default"](title, description, dueDate, this.name);
...
module.exports = __webpack_require__.p + "0cd5721082beb1d9c90b.svg";
...
module.exports = __webpack_require__.p + "6dd749a958ebc902e009.svg";
...
module.exports = __webpack_require__.p + "cedb2e1b385a078a834e.svg";
...
module.exports = __webpack_require__.p + "02cccadebfedfbcf81d7.svg";
...
/* harmony import */ var _classes_DomController_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./classes/DomController.js */ "./src/classes/DomController.js");
...
const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(new Date(), 'yyyy-MMM-dd');
console.log('Formatted Date:', formattedDate);



function init(){
    const domController = new _classes_DomController_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
...
function addNewProject(name){
    return new _classes_Project_js__WEBPACK_IMPORTED_MODULE_1__["default"](name);
}
