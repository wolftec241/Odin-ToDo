...
class DomController {
    ...
    newTaskContainer(task) {
        ...
        date.textContent = this.isExpose(task.getDueDate()) ? "Expired" : (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(task.getDueDate(), 'dd/MM/yyyy');
