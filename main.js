...
class DomController {
    ...
    addingNewProject() {
        ...
        projectContainer.addEventListener("submit", (event) => {
            event.preventDefault();
            this.createProjectContainer(new _Project_js__WEBPACK_IMPORTED_MODULE_1__["default"](title.value));
