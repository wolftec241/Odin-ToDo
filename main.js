...
.create-task-container-title{
    padding: 10px;
    margin: 0;
}

.create-task-container-closer{
...
class DomController {
    ...
    addNewTask() {
        ...
        const task = new _Task_js__WEBPACK_IMPORTED_MODULE_0__["default"](titleInput.value, description.value, dueDate.value);
    ...
    isExpose(date) {
        return !((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isBefore)(date, new Date()));
    }
    ...
    newTaskContainer(task) {
        ...
        "Expired":
        (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(task.getDueDate(), 'dd/MM/yyyy');
    ...
    addingNewProject(){
        ...
        addBtn.addEventListener("submit", () =>{
            projects.appendChild(new _Project_js__WEBPACK_IMPORTED_MODULE_1__["default"](title.value));
